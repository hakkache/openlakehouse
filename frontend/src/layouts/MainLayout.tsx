...
export default function MainLayout() {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-slate-50">
      <aside className="slim-scroll flex w-64 shrink-0 flex-col overflow-y-auto border-r border-slate-800/60 bg-gradient-to-b from-slate-900 to-slate-950 px-3 py-4">
        <div className="mb-6 flex items-center gap-2.5 px-2">
          ...
          <span className="text-[15px] font-semibold tracking-tight text-white">OpenLakehouse</span>
        </div>
